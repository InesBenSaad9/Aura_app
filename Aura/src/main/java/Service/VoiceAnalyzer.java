...
import Interface.Analyzable;
import javax.sound.sampled.*;
import java.io.*;

public class VoiceAnalyzer implements Analyzable {
    ...
    public String analyzeVoiceMood() {
        try {
                ...
                if (mixerInfo.getName().contains("Realtek")) {
                    try {
                        ...
                        if (mixer.isLineSupported(info)) {
                            ...
                            System.out.println("Micro : " + mixerInfo.getName());
                            break;
                        }
                    } catch (Exception e) {
                        continue;
            ...
            System.out.println("Audio sauvegardé !");
    ...
    private String detectMood(double energy, double pitch) {
        System.out.println("DEBUG — Énergie: " + energy + " | Pitch: " + pitch);
