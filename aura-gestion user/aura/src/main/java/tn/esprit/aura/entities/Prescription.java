...
public class Prescription {
    ...
    // Aliases expected by some controllers / older code
    public String getPatientNom() { return getPatientUsername(); }
    public void setPatientNom(String patientNom) { setPatientUsername(patientNom); }

    public String getDocteurUsername() { return docteurUsername; }
    public String getDoctorNom() { return docteurUsername; }
    public String getDocteurNom() { return docteurUsername; }
